...
<template>
    <div class="surface-0 flex justify-content-between items-center">
      <div id="home" class="landing-wrapper overflow-hidden">
        <div class="py-4 px-4 mx-0 md:mx-6 lg:mx-8 lg:px-8 flex align-items-center justify-content-between relative lg:static mb-3">
          <div class="d-flex align-items-center w-full">
            ...
            <ul class="list-none p-0 m-0 flex lg:align-items-center select-none flex-row cursor-pointer w-75">
              <li>
              ...
              <li>
                <router-link :to="{ name: 'Login' }" class="flex m-0 md:ml-5 px-0 py-3 text-900 font-medium line-height-3 p-ripple" v-ripple>
                  <i class="navbar-icon pi pi-sign-in"></i> <span>LOG IN</span>
                </router-link>
              </li>
              <li>
                <router-link :to="{ name: 'Register' }" class="flex m-0 md:ml-5 px-0 py-3 text-900 font-medium line-height-3 p-ripple" v-ripple>
                  <i class="navbar-icon pi pi-user-plus"></i> <span>SIGN UP</span>
                </router-link>
              </li>
              <li class="ml-auto"> <!-- Added ml-auto class to push search and profile icons to the right -->
                <i class="pi pi-search" style="font-size: 1.2em; margin-right: 16px;"></i> <!-- Search icon -->
                <i class="pi pi-user" style="font-size: 1.2em;"></i> <!-- Profile icon -->
              </li>
            </ul>
          </div>
        </div>
