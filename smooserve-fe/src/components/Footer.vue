<template>
    <div class="footer">
      ...
      <div class="content">
        ...
        <div class="details">
          ...
          <p><a href="#">+65 8123 4567</a></p>
          <h4 class="mail">Email</h4>
          <p><a href="SmooServe@gmail.com">SmooServe@gmail.com</a></p>
        </div>
      </div>
      <footer>
        <hr />
  ...
  * {
  ...
  .footer {
  background-color: rgb(173, 183, 230);
  color: black;
  ...
  padding: 10px 0; /* Add some padding to the top and bottom of the footer */
}
