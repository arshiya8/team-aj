                          ...
                          <div class="flex flex-column gap-3 mb-3 justify-center items-center">
                              <TabView style="width: 100%;">
                                      ...
                                      <div v-scrollanimation class="p-3 mt-2 mb-2 card">
                                          <div class="surface-section">
                                              ...
                                              <ul v-if="quizPreference" class="list-none p-0 m-0">
                                                  ...
                                                  <li v-scrollanimation v-for="cause in quizPreference.passionate_about"
                                                      :key="cause.id"
                                                      class="flex align-items-center py-3 px-2 border-top-1 surface-border flex-wrap">
                                                  ...
                                                  <li v-scrollanimation v-for="skill in quizPreference.skills" :key="skill.id"
                                                      class="flex align-items-center py-3 px-2 border-top-1 surface-border flex-wrap">
                                                  ...
                                                  <li v-scrollanimation v-for="exp in quizPreference.volunteering_experience"
                                                      :key="exp.id"
                                                      class="flex align-items-center py-3 px-2 border-top-1 surface-border flex-wrap">
                                                  ...
                                                  <li v-scrollanimation v-for="loc in quizPreference.volunteering_location"
                                                      :key="loc.id"
                                                      class="flex align-items-center py-3 px-2 border-top-1 surface-border flex-wrap">
                                  ...
                                  <TabPanel header="Registered CSPs">
                                      ...
                                      <DataTable v-else v-scrollanimation :value="registeredCSPs" tableStyle="min-width: 50rem">
                                          <Column v-scroll field="title" header="Registered CSP"></Column>
                                          <Column v-scroll field="status" header="Status"></Column>
                                          <Column v-scroll field="link" header="Interview Link"></Column>
