              ...
              <div class="col-12 md:col-12 lg:col-6">
                  <Card class="p-3 mt-4 mb-4 card container-fluid" style="width: 50em;">
                      ...
                      <template class="container-fluid" #header style="text-align: center; position: relative;">
                          ...
                          <div class="grid align-items-center justify-content-center mb-3" style="transform: translate(0, -60%);">
...
const uploadImage = async (file) => {
  try {
      const storageRef = sRef(storage, `images/${studentId}/${file.name}`);
...
function save() {
  ...
  axios
      .put(`https://localhost:8080/api/student/${studentId}`)
      .then((response) => {
          toast.add({
              severity: "success",
              summary: "Done",
